...
Encrypt audio block (AES-GCM)

Encrypt session key using embedded public key
...
Yes — it is possible to build Android APKs using nothing but a browser, even from another Android device.
...
Public key implementation details

Exact AES flow

AMR encoding details
...
And then add a simple:

If you build both APKs and your hashes match, you get your own green tick.
